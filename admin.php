...
<head>
    ...
    <title>ADMIN - Desa Girimulyo</title>
...
<body>
    <div class="container-fluid px-0">
                ...
                <nav class="ml-auto">
                    <ul class="nav">
                        ...
                        <div class="tentang-kami">
                            <li class="nav-item mx-2"><a href="tentang_kami/admin.html" class="nav-link">Tentang Kami</a></li>
                        </div>
                        <div class="search">
                            <li class="nav-item mx-2"><a href="searchadmin.php" class="nav-link">Search</a></li>
                        </div>
                    </ul>
                </nav>
            </div>
        ...
        <section class="container-fluid my-0 px-3">
            <div class="row">
                <div class="container-fluid px-0 col-md-6">
                    ...
                    <ul class="nav">
                        <div class="dashboard">
                            <li class="nav-item mx-2"><a href="admin_edit-profile.php" class="nav-link">Edit Profile</a></li>
                        </div>
                    </ul>
                ...
                <ul class="nav">
                <div class="dashboard">
                    <li class="nav-item mx-2"><a href="admin_edit-potensi.php" class="nav-link">Edit Potensi</a></li>
                </div>
            </ul>
            </div>
        </section>
        ...
        <div class="commodities container-fluid my-5 px-5">
            ...
            <ul class="nav">
                <div class="dashboard">
                    <li class="nav-item mx-2"><a href="admin_edit-komoditi.php" class="nav-link">Edit Komoditas</a></li>
                </div>
            </ul>
        </div>
        <div class="container">
